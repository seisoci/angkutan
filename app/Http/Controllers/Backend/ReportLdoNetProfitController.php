...
class ReportLdoNetProfitController extends Controller
{
  ...
  public function document(Request $request)
  {
    ...
    $sheet->setCellValue('M1', $profile['name']);
    $sheet->mergeCells('M2:O2');
    $sheet->setCellValue('M2', $profile['address']);
    $sheet->mergeCells('M3:O3');
    $sheet->setCellValue('M3', 'Telp: ' . $profile['telp']);
    $sheet->mergeCells('M4:O4');
    $sheet->setCellValue('M4', 'Fax: ' . $profile['fax']);
  ...
  public function print(Request $request)
  {
    ...
    return view('backend.report.reportldonetprofit.print', compact('config', 'page_breadcrumbs', 'profile', 'data', 'date', 'anotherExpedition'));
  }
