...
class ReportLedgerOperationalController extends Controller
{
  use CarbonTrait;

  function __construct()
  {
    $this->middleware('permission:ledgeroperational-list|ledgeroperational-create|ledgeroperational-edit|ledgeroperational-delete', ['only' => ['index']]);
  }

  public function index(Request $request)
  {
    $config['page_title'] = "Laporan Buku Besar Operasional";
    $config['page_description'] = "Laporan Buku Besar Operasional";
    $config['excel_url'] = 'ledgeroperational/document?type=EXCEL';
    $config['pdf_url'] = 'ledgeroperational/document?type=PDF';
    $config['print_url'] = 'ledgeroperational/print';
    $page_breadcrumbs = [
      ['page' => '#', 'title' => "Laporan Buku Besar Operasional"],
    ];
    ...
    return view('backend.report.reportledgeroperational.index', compact('config', 'page_breadcrumbs', 'data', 'date'));
  }
  ...
  public function document(Request $request)
  {
    ...
    $sheet->setCellValue('A1', 'Laporan Buku Besar Operasional');
    ...
    foreach ($data as $keyCollection => $itemCollection):
      ...
      endforeach;
    endforeach;
    $filename = 'Laporan Buku Besar Operasional ' . $this->dateTimeNow();
    if ($type == 'EXCEL') {
