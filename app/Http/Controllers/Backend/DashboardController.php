...
class DashboardController extends Controller
{
    public function __invoke(){
      ...
      return view('backend.dashboard',compact('config', 'page_breadcrumbs', 'expired_sim', 'expired_kir', 'expired_stnk', 'job_order_document', 'driver_count', 'transport_count', 'joborder_count', 'sparepart_count'));
    }
}
