...
class ReportRecapSalaryController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('backend.report.reportrecapsalary.index', compact('config', 'page_breadcrumbs'));
  }
  ...
  public function print(Request $request)
  {
    ...
    return view('backend.report.reportrecapsalary.print', compact('config', 'page_breadcrumbs', 'profile', 'data', 'date', 'driver'));
  }
