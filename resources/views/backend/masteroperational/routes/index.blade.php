...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form id="formStore" action="{{ route('backend.routes.store') }}">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control form-control-solid" placeholder="Input Nama Rute" />
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.routes.index') }}",
        columns: [
            {data: 'name', name: 'name'},
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
      ...
      $(this).find('.modal-body').find('a[name="id"]').attr('href', '{{ route("backend.routes.index") }}/'+ id);
    });
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
      ...
      $(this).find('#formUpdate').attr('action', '{{ route("backend.routes.index") }}/'+id)
