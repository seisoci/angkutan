      ...
      <form id="formStore" action="{{ route('backend.banks.store') }}">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name_bank" class="form-control form-control-solid" placeholder="Input Nama Bank" />
          </div>
          <div class="form-group">
            <label>Cabang</label>
            <input type="text" name="branch" class="form-control form-control-solid" placeholder="Input Nama Cabang" />
          </div>
          <div class="form-group">
            <label>Nama Pemilik</label>
            <input type="text" name="name" class="form-control form-control-solid" placeholder="Input Nama Pemilik" />
          </div>
          <div class="form-group">
            <label>No. Rekening</label>
            <input type="text" name="no_account" class="form-control form-control-solid" placeholder="Input No. Rekening" />
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
      let id = $(event.relatedTarget).data('id');
      let name_bank = $(event.relatedTarget).data('name_bank');
      let name = $(event.relatedTarget).data('name');
      let no_account = $(event.relatedTarget).data('no_account');
      let branch = $(event.relatedTarget).data('branch');
      $(this).find('#formUpdate').attr('action', '{{ route("backend.banks.index") }}/'+id)
      $(this).find('.modal-body').find('input[name="name_bank"]').val(name_bank);
      $(this).find('.modal-body').find('input[name="name"]').val(name);
      $(this).find('.modal-body').find('input[name="no_account"]').val(no_account);
      $(this).find('.modal-body').find('input[name="branch"]').val(branch);
    });
    $('#modalEdit').on('hidden.bs.modal', function (event) {
      $(this).find('.modal-body').find('input[name="name_bank"]').val('');
      $(this).find('.modal-body').find('input[name="name"]').val('');
      $(this).find('.modal-body').find('input[name="no_account"]').val('');
      $(this).find('.modal-body').find('input[name="branch"]').val('');
    });
