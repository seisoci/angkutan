...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form id="formStore" action="{{ route('backend.expenses.store') }}">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control form-control-solid" placeholder="Input Nama Barang" />
          </div>
          <div class="form-group">
            <label>Nominal</label>
            <input type="text" name="amount" class="currency form-control form-control-solid"
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
      ...
      $(this).find('.modal-body').find('a[name="id"]').attr('href', '{{ route("backend.expenses.index") }}/'+ id);
    });
