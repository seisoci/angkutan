            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-3 my-md-0">
                <div class="form-group">
                  ...
                  <select class="form-control" id="selectStatusLdo">
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      let dataTable = $('#Datatable').DataTable({
        ...
        ajax: {
          ...
          data: function (d) {
            ...
            d.status_ldo = $('#selectStatusLdo').find(':selected').val();
          }
        },
        columns: [
      ...
      $("#select2Driver").select2({
        ...
        allowClear: true,
        ajax: {
          url: "{{ route('backend.drivers.select2ldo') }}",
          dataType: "json",
          delay: 250,
          cache: true,
          data: function (e) {
      ...
      $("#select2Transport").select2({
        ...
        allowClear: true,
        ajax: {
          url: "{{ route('backend.transports.select2ldo') }}",
          dataType: "json",
          delay: 250,
          cache: true,
          data: function (e) {
      ...
      $('#selectStatusLdo').on('change', function () {
        dataTable.draw();
      });
