...
<div class="card card-custom">
  <div class="card-header flex-wrap py-3">
    ...
    <div class="card-toolbar">
      ...
      <!--end::Dropdown-->
      <!--begin::Button-->
      <a href="{{ route('backend.drivers.create') }}" class="btn btn-primary font-weight-bolder">
        <span class="svg-icon svg-icon-md">
  ...
  $(function () {
    var dataTable = $('#Datatable').DataTable({
        ...
        },
        {
          ...
          render: function(data, type, full, meta) {
            var status = {
              'active': {'title': 'Inactive', 'class': ' label-light-danger'},
              'inactive': {'title': 'Active', 'class': ' label-light-success'},
            };
