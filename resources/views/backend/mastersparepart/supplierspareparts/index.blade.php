...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form id="formStore" action="{{ route('backend.supplierspareparts.store') }}">
        @csrf
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <input type="text" name="name" class="form-control form-control-solid col-md-9"
            placeholder="Input Nama Supplier" disabled />
        </div>
        <div class="form-group row">
          <label class="col-md-3">No. Telp/HP Supplier</label>
          <input type="text" name="phone" class="phone form-control form-control-solid col-md-9"
            placeholder="Input No. Telp/HP Supplier" disabled />
        </div>
        <div class="form-group">
          <label>Alamat</label>
...
<script type="text/javascript">
  $(document).ready(function(){
    var dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.supplierspareparts.index') }}",
        columns: [
            {data: 'name', name: 'name'},
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
      ...
      $(this).find('.modal-body').find('a[name="id"]').attr('href', '{{ route("backend.supplierspareparts.index") }}/'+ id);
    });
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
      ...
      $(this).find('#formUpdate').attr('action', '{{ route("backend.supplierspareparts.index") }}/'+id)
