  ...
  <div class="card card-custom">
    <div class="card-header flex-wrap py-3">
      ...
      <div class="card-toolbar">
        <!--begin::Button-->
        <a href="{{ route('backend.completepurchaseorder.create') }}" class="btn btn-primary font-weight-bolder">
  ...
  <script type="text/javascript">
    $(function () {
      ...
      $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        $(this).find('.modal-body').find('a[name="id"]').attr('href', '{{ route("backend.completepurchaseorder.index") }}/' + id);
      });
