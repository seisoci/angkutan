...
<body>
  <div class="row justify-content-center py-8 px-8 px-md-0">
    <div class="col-md-11">
      ...
      <table class="table table-borderless table-title">
        <tbody>
          <tr>
            ...
            <td scope="col" class="text-left" style="padding-left:2rem;width:10%">No. Kasbon</td>
          ...
          <tr>
            ...
            <td scope="col" class="text-left" style="width:10%"></td>
            <td scope="col" class="text-left" style="padding-left:2rem;width:10%">Supir</td>
            <td scope="col" class="text-left" style="width:2%">&ensp;: &ensp;</td>
            <td scope="col" class="text-left" style="width:20%"> {{ $data->driver->name }}</td>
          </tr>
          <tr>
            <td scope="col">{{ $profile['telp'] ?? ''}}</td>
            <td scope="col" class="text-left" style="width:10%"></td>
            <td scope="col" class="text-left" style="padding-left:2rem;width:10%">Tanggal</td>
            <td scope="col" class="text-left" style="width:2%">&ensp;: &ensp;</td>
            <td scope="col" class="text-left" style="width:20%"> {{ $data->created_at }}</td>
          </tr>
          <tr>
            <td scope="col" colspan="5">FAX {{ $profile['fax'] ?? ''}}</td>
          </tr>
          <tr>
      ...
      <h5 class="font-weight-boldest text-left text-uppercase text-dark">Pembayaran</h5>
      <table class="table">
        <thead>
          <tr>
            <th scope="col" style="width:5%">#</th>
