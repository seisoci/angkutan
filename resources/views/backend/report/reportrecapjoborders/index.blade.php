  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 25,
        ajax: {
          url: "{{ route('backend.reportrecapjoborders.index') }}",
          data: function (d) {
        ...
        columns: [
          ...
          {data: 'costumer_address', name: 'costumer_address'},
          {data: 'report_qty', name: 'report_qty'},
          {
            data: 'report_basic_price', name: 'report_basic_price',
            defaultContent: 0,
            className: 'dt-right',
        ...
        footerCallback: function (row, data, start, end, display) {
          ...
          $(api.column(2).footer()).html(format(totalQty));
          $(api.column(3).footer()).html(format(totalBasic));
          $(api.column(4).footer()).html(format(totalBasicTax));
          $(api.column(5).footer()).html(format(totalThanks));
          $(api.column(6).footer()).html(format(totalBasicThanks));
