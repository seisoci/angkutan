    ...
    <div class="col-md-11">
      ...
      <table style="padding-top: 0 !important; padding-bottom: 0 !important; margin-bottom: 0 !important; border-left: 1px solid #000 !important;
        ...
        <tr>
          ...
          <td style="text-align: right; font-weight: bold">{{ number_format($data->sum('total_basic_price'), 2, ',', '.') }}</td>
          <td style="text-align: right; font-weight: bold">{{ number_format($data->sum('total_basic_price_after_thanks'), 2, ',', '.') }}</td>
          <td style="text-align: right; font-weight: bold">{{ number_format($data->sum('total_basic_price_ldo'), 2, ',', '.') }}</td>
          <td style="text-align: right; font-weight: bold">{{ number_format(($data->sum('total_basic_price') - $data->sum('total_basic_price_ldo')), 2, ',', '.') }}</td>
          <td style="text-align: right; font-weight: bold">{{ number_format(($data->sum('total_basic_price_after_thanks') - $data->sum('total_basic_price_ldo')), 2, ',', '.') }}</td>
        </tr>
        </tfoot>
      </table>
    </div>
