...
<div class="row justify-content-center py-8 px-8 px-md-0">
  <div class="col-md-11">
    <h2 class="font-weight-boldest text-center mb-10 text-uppercase text-dark"><u>LAPORAN RECAP PURCHASE ORDER</u>
    </h2>
    <table class="table table-borderless table-title">
      ...
      <tr>
        <td scope="col" class="font-weight-normal" style="width:50%">Nama Supllier: {{ $supplier }}
        <td scope="col" class="text-left" style="width:10%"></td>
    ...
    <table class="table">
      ...
      <td class="text-right">{{ number_format($data->sum('total_bill'), 2, ',', '.') }}</td>
      <td class="text-right">{{ number_format($data->sum('total_payment'), 2, ',', '.') }}</td>
      <td class="text-right">{{ number_format($data->sum('discount'), 2, ',', '.') }}</td>
      <td class="text-right">{{ number_format($data->sum('rest_payment'), 2, ',', '.') }}</td>
      <td></td>
      </tfoot>
    </table>
  </div>
