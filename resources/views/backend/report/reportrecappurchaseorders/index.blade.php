  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 25,
        ajax: {
          url: "{{ route('backend.reportrecappurchaseorders.index') }}",
          data: function (d) {
        ...
        columns: [
          ...
          {
            data: 'rest_payment', name: 'rest_payment',
            defaultContent: 0,
            className: 'dt-right',
            render: $.fn.dataTable.render.number(',', '.', 2)
          },
        ...
        footerCallback: function (row, data, start, end, display) {
          ...
          $(api.column(4).footer()).html(format(totalBill));
          $(api.column(5).footer()).html(format(totalPayment));
          $(api.column(6).footer()).html(format(discount));
          $(api.column(7).footer()).html(format(restPayment));
