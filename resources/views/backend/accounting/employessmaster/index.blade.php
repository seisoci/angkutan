...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form id="formStore" action="{{ route('backend.employeesmaster.store') }}">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Nama Tipe Gaji</label>
            <input type="text" name="name" class="form-control form-control-solid" placeholder="Input Nama Tipe Gaji" />
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    var dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.employeesmaster.index') }}",
        columns: [
            {data: 'name', name: 'name'},
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
      ...
      $(this).find('.modal-body').find('a[name="id"]').attr('href', '{{ route("backend.employeesmaster.index") }}/'+ id);
    });
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
      ...
      $(this).find('#formUpdate').attr('action', '{{ route("backend.employeesmaster.index") }}/'+id)
