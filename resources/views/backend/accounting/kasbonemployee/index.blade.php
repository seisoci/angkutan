...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form id="formStore" action="{{ route('backend.kasbonemployees.store') }}">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select id="select2Employee" name="employee_id" class="form-control" style="width:100%">
            </select>
          </div>
          <div class="form-group">
            <label>Nominal</label>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.kasbonemployees.index') }}",
        columns: [
    ...
    $('#modalCreate').on('hidden.bs.modal', function (event) {
      $("#select2Employee").val('').trigger('change');
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
      ...
      $(this).find('.modal-body').find('select[name="employee_id"]').val(x);
      $(this).find('.modal-body').find('input[name="amount"]').val(amount);
    });
    $('#modalEdit').on('hidden.bs.modal', function (event) {
      $(this).find('.modal-body').find('select[name="employee_id"]').val('');
      $(this).find('.modal-body').find('input[name="amount"]').val('');
    });
